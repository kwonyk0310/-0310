...
/* 		#product_sidebar li{
		...
		#product_sidebar li:first-child{
			border-top: 0px solid #5a6268;
		}
		#product_sidebar li:last-child{
		...
		<ul id="product_sidebar">
			<li>
				<a href="<%=NoForm%>pcategorylist&mode=eyes&${requestScope.parameters}">
					<img src="${pageContext.request.contextPath}/images/icon/icon_eyes.png">
				</a>
			</li>
			<li>
				<a href="<%=NoForm%>pcategorylist&mode=bloodcirculation&${requestScope.parameters}">
					<img src="${pageContext.request.contextPath}/images/icon/icon_bloodcirculation.png">
				</a>
			</li>
			<li>
			...
			<li>
				<a href="<%=NoForm%>pcategorylist&mode=skin&${requestScope.parameters}">
					<img src="${pageContext.request.contextPath}/images/icon/icon_skin.png">
				</a>
			</li>
			<li>
				<a href="<%=NoForm%>pcategorylist&mode=fatigue&${requestScope.parameters}">
					<img src="${pageContext.request.contextPath}/images/icon/icon_fatigue.png">
				</a>
			</li>
			<li>
				<a href="<%=NoForm%>pcategorylist&mode=joint&${requestScope.parameters}">
					<img src="${pageContext.request.contextPath}/images/icon/icon_joint.png">
				</a>
			</li>
			<li>
				<a href="<%=NoForm%>pcategorylist&mode=hair&${requestScope.parameters}">
					<img src="${pageContext.request.contextPath}/images/icon/icon_hair.png">
				</a>
			</li>
			<li>
						...
						<div class="product-card">
							<div class="mask">
								<a href="<%=NoForm%>pdetail&productcode=${bean.productcode}&${requestScope.parameters}">
									<img src="${pageContext.request.contextPath}/images/product/${bean.images}" class="img-fluid w-100" width="200" height="300" alt="${bean.images}">
								</a>
							</div>
						...
						￦<fmt:formatNumber value="${bean.productprice}" pattern="###,###"/>
								...
								<div>
									<form class="form-inline" role="form" method="post" action="<%=YesForm%>">
										...
										<button type="submit" class="btn btn-outline-info btn-sm mr-1 mb-2">장바구니에 추가하기
										</button>
									</form>
									...
									<form class="form-inline" role="form" name="myform" action="<%=YesForm%>" method="post">
										...
										<button type="submit" class="btn btn-outline-info btn-sm mr-1 mb-2">정기 구매 신청하기
										</button>
									</form>
								</div>
								<div>
